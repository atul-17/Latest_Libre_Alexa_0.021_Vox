    ...
    fun getAllDevicesGetApi() {
        ...
        val jsonObjectRequest: JsonObjectRequest = object : JsonObjectRequest(
                ...
                Response.Listener { response ->
                    ...
                    modelAllDevicesResponse.code = response.getInt("code")
                    modelAllDevicesResponse.msg = response.getString("msg")

                    if (response.has("devicelist")) {

                        val deviceListJSonArray = response.getJSONArray("devicelist")
                        ...
                        for (i in 0 until deviceListJSonArray.length()) {
                            ...
                            modelGetAllDevicesResponse.deviceId =
                                    deviceJsonObject.getString("deviceId").toInt()
