...
import com.libre.alexa.activities.oldFlow.VodafoneAllowLinkGenieAlexaActivity;
import com.libre.alexa.activities.oldFlow.VodafoneDinnerTimeMainSplashActivity;
import com.libre.alexa.activities.oldFlow.VodafoneSelectDinnerTimeDevicesListActivity;
...
//    private LinearLayout btnAlexaEnable;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPcoLink.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LSSDPDeviceNetworkSettings.this, VodafoneAllowLinkGenieAlexaActivity.class);
